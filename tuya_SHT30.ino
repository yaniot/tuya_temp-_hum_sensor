...
void get_sht30_value(int *temp_value, int *humi_value)
{
  ...
  if (Wire.available() == 6) {
    ...
    if ((sht30_crc(i2c_data, 2) == i2c_data[2]) && (sht30_crc(i2c_data+3, 2) == i2c_data[5])) {/* crc success */
      *temp_value = (((((i2c_data[0] * 256.0) + i2c_data[1]) * 175) / 65535.0) - 45)*10;
      *humi_value = ((((i2c_data[3] * 256.0) + i2c_data[4]) * 100) / 65535.0);
    } else {
      *temp_value = 0;
      *humi_value = 0;
    }
